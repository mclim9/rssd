...
### Loops
Repeat  = 10
swpTimeArry = [0, 2e-3, 3e-3, 5e-3, 1e-2, 2e-2, 3e-2, 5e-2, 1e-1, 2e-1, 3e-1, 5e-1]
...
OFile.write(f'{LoopParam},{FSW.Get_Params(1,1,1,1,1)},{FSW.Get_Params_MkrBand(1)},{TMR.Get_Params_Time(1)},YIGStat,')
    ...
    for yig in ['ON','OFF']:
        ...
        for SwpTime in swpTimeArry:
            for rbw in rbwArry:
                ...
                OutStr      = f'{LoopParam},{FSW.Get_Params(1,1,1,1,0)},{MeasData},{TotTime},{yig}'
                OFile.write(OutStr)
