...
# cat = cat_FR2
mode_arry   = [[1,50,15,60,cat_FR1a_15],
                [1,100,30,273,cat_FR1b_30],
                [1,100,60,135,cat_FR1b_60],
                [2,200,60,264,cat_FR2_60],
...
for mode in mode_arry:
    ...
    for file in mode[4]:
        ...
        if Fil == file:
            ...
            SMW.Set_5GNR_savesetting(f'FRC/{file}-{SCS}-{NRB}-{MOD}-{PAS}')
            SMW.Set_5GNR_saveAllocation(f'FRC/{file}-{SCS}-{NRB}-{MOD}-{PAS}')
